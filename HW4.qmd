...
cites <- read.csv(here("data/exports_imports.csv")) %>% 
  clean_names()

# Gross exports data 
gross_exports <- read.csv(here("data/exports.csv")) %>% 
  clean_names()
...
legend <- readPNG(here("images/legend.png"))
...
#leopard image
leopard <- png::readPNG(here("images/leopard.png"))
...
#cheetah image
cheetah <- readPNG(here("images/cheetah2.png"))
...
# tiger image
tiger <- readPNG(here("images/tiger.png"))
...
# CITES logo 
cites <- readPNG(here("images/cites_logo.png"))
